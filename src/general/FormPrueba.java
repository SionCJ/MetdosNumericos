...
public class FormPrueba extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/taylor/recursos/fx1.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        double pto1 = Double.parseDouble( p1.getText() );
        double pto2 = Double.parseDouble( p2.getText() );
        plano1.setPuerto(pto1, pto2, -10, 10);
        plano1.repaint();
    ...
    public void paint(Graphics g){
        super.paint(g);
        g = plano1.getGraphics();
        g.drawLine(10, 0, 200, 0);
        g.drawLine(10, 100, 200, 100);
        g.drawLine(10, plano1.getHeight(), 200, plano1.getHeight());
    }
    /**
